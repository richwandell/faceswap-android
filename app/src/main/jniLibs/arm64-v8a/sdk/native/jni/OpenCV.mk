...
OPENCV_MODULES:=stitching superres videostab aruco bgsegm bioinspired face photo objdetect img_hash optflow structured_light phase_unwrapping text tracking dnn plot xfeatures2d shape video ml ximgproc calib3d features2d highgui videoio imgcodecs flann xphoto imgproc core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=stitching superres videostab aruco bgsegm bioinspired face photo objdetect img_hash optflow structured_light phase_unwrapping text tracking dnn plot xfeatures2d shape video ml ximgproc calib3d features2d highgui videoio imgcodecs flann xphoto imgproc core
    OPENCV_LIB_TYPE:=SHARED
else
